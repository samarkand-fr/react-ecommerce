        ...
        <div className="row">
          <div className="col-md-3 col-sm-6 mb-3 px-3">
            <div className="card h-100">
              <img className="card-img-top img-fluid" src={mencollection} alt="" height={160} />
          ...
          <div className="col-md-3 col-sm-6 mb-3 px-3">
            <div className="card h-100">
              <img className="card-img-top img-fluid" src={womenCollection} alt="" height={160} />
              <div className="card-body">
          ...
          <div className="col-md-3 col-sm-6 mb-3 px-3">
            <div className="card h-100">
              <img className="card-img-top img-fluid" src={jewlery} alt="" height={160} />
              <div className="card-body">
          ...
          <div className="col-md-3 col-sm-6 mb-3 px-3">
            <div className="card h-100">
              <img className="card-img-top img-fluid" src={electronics} alt="" height={160} />
              <div className="card-body">
